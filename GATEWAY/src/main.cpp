...
const char* password = "giallopikachu";
const char* serverAddress = "192.168.108.26"; //equivale all'indirizzo IP privato del pc su cui gira il server
...
void loop()
{
  ...
  if (manager.recvfromAck(buf, &len, &from)){
    Serial.println("request from node n.");
    Serial.print(from);
    Serial.print(": ");
